class User < ApplicationRecord
  ...
  # both microposts and active relationships are dependent on destroy as if a user is destroyed
  # their micropost and relationships should also be destroyed
  ...
  # Returns a user feed with microposts from the followed users and from self.
  def feed
